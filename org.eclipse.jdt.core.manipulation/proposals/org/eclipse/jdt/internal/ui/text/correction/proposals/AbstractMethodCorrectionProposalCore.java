...
public abstract class AbstractMethodCorrectionProposalCore extends LinkedCorrectionProposalCore {
	private ASTNode fNode;
	private ITypeBinding fSenderBinding;

	public AbstractMethodCorrectionProposalCore(String label, ICompilationUnit targetCU, ASTNode invocationNode, ITypeBinding binding, int relevance) {
