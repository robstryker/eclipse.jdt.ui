...
public class MissingReturnTypeCorrectionProposalCore extends LinkedCorrectionProposalCore {
	...
	public MissingReturnTypeCorrectionProposalCore(ICompilationUnit cu, MethodDeclaration decl, ReturnStatement existingReturn, int relevance) {
